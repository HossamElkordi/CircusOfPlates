...
public class turquoiseBox extends fallingObject{
    ...
    public turquoiseBox(){
        ...
        try {
            spriteImages[0] = ImageIO.read(new File("CircusPlates"+ System.getProperty("file.separator") + "res" +System.getProperty("file.separator") + "Images"+ System.getProperty("file.separator")  +"turquoiseboxsmall.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
