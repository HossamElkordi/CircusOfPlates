...
public class greenBall extends fallingObject{
    ...
    public greenBall(){
        ...
        try {
            spriteImages[0] = ImageIO.read(new File("CircusPlates"+ System.getProperty("file.separator") + "res" +System.getProperty("file.separator") + "Images"+ System.getProperty("file.separator")  +"greenball.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
