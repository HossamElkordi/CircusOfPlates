...
public class originalBall extends fallingObject{
    ...
    public originalBall(){
        ...
        try {
            spriteImages[0] = ImageIO.read(new File("CircusPlates"+ System.getProperty("file.separator") + "res" +System.getProperty("file.separator") + "Images"+ System.getProperty("file.separator")  +"orangeball.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
